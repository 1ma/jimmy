...
final class LegacyTxTest extends TestCase
{
    ...
    private const string SIMPLE_TX = '';
    private const string LARGE_TX  = '';
    private const string P2SH_TX   = '';

    private const string COINBASE_TX = '';
...
TXT;
    ...
    public function testTransactionCreation(): void
    {
        ...
        $txOut1 = new Tx\Output(14424, Tx\Script::payToPubKeyHash(Encoding\Address::decode('n14VanAQTFrZcMV8GqfUQmors2NCUBXCin')));
        $txOut2 = new Tx\Output(4878, Tx\Script::payToPubKeyHash(Encoding\Address::decode('mfoZu55yYex1X575MRpHJc8yDDttzvyx3M')));
...
TXT;
    ...
    public function testCoinbaseTransactionIdentification(): void
    {
        $coinbase = Tx::parse(self::stream(hex2bin(self::COINBASE_TX)));
        $regular  = Tx::parse(self::stream(hex2bin(self::SIMPLE_TX)));

        self::assertTrue($coinbase->isCoinbase());
        self::assertFalse($regular->isCoinbase());

        self::assertSame(200000, $coinbase->blockHeight());
        self::assertFalse($regular->blockHeight());
    }
}
